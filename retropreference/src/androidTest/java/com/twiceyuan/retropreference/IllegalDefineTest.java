...
public class IllegalDefineTest {
    ...
    public void illegalFileName() {
        try {
            RetroPreference.INSTANCE.createKt(mAppContext, IllegalFileName.class, Context.MODE_PRIVATE);
        } catch (Exception e) {
    ...
    public void illegalKeyName() {
        try {
            IllegalKeyName settings = RetroPreference.INSTANCE.createKt(mAppContext, IllegalKeyName.class, Context.MODE_PRIVATE);
